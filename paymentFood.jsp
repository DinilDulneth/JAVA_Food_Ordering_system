...
<body>
    ...
    <div class="form-container">
        ...
        <form action="pay" method="POST">
			...
			<input type="number" name="quntity" required title="Please enter a valid quantity" min="1" pattern="\d+" oninput="this.setCustomValidity('');" oninvalid="this.setCustomValidity('Please enter a positive integer.')" placeholder="Enter quantity">
